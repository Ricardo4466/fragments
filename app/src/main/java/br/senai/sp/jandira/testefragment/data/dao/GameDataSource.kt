    ...
    companion object {
        fun getGames(context: Context): ArrayList<Game> {
            ...
            games.add(Game(1,
                ...
                3.0f,
                listOf(
                    Console(1,context.getDrawable(R.drawable.resident_evil_4)!! ,"Playstation 1", "Sony", "1996-12-01", "vsdvsdvsd"),
                    Console(2,context.getDrawable(R.drawable.resident_evil_4)!! ,"Xbox 360", "Microsoft", "1986-12-01", "vsdvsdvsd"),
                    Console(3,context.getDrawable(R.drawable.resident_evil_4)!! ,"PC", "Microsoft", "1986-12-01", "vsdvsdvsd")))
            )
            games.add(Game(2,
                "Resident evil 4",
            ...
            games.add(Game(3,
                ...
                4.5f,
                listOf(
                    Console(1,context.getDrawable(R.drawable.resident_evil_4)!! ,"Playstation 2", "Sony", "1996-12-01", "vsdvsdvsd"),
                    Console(2,context.getDrawable(R.drawable.resident_evil_4)!! ,"Xbox 360", "Microsoft", "1986-12-01", "vsdvsdvsd")))
            )
                games.add(Game(4,
                "Counter Strike",
